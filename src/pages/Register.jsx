...
export const Register = () => {
  const [username, setUsername] = useState("admina"); // Changed from email to username
  ...
  const handleRegister = (e) => {
    ...
    fetch(`http://localhost:8000/register`, {
      // Ensure the URL matches the backend's URL pattern
      method: "POST",
      body: JSON.stringify({
    ...
    <main className="container--login">
      ...
      <section>
        <form className="form--login" onSubmit={handleRegister}>
          <h1 className="text-4xl mt-7 mb-3">Recipe Book</h1>
          ...
          <fieldset className="mb-4">
            ...
            {/* Changed from inputEmail to inputUsername */}
            <input
              type="text"
              id="inputUsername"
